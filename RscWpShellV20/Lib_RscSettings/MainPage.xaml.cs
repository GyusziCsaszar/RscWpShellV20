...
namespace Lib_RscSettings
{
    ...
    public partial class MainPage : PhoneApplicationPage
    {
		...
		const string csTitle = "System Settings";
		
		const string csAssyName = "/Lib_RscSettings;component/";
		
		private void AddApps( )
		{
			m_asApps.Add( new GalleryItem( "RscThemesV11;Images/Ico001_Themes.jpg", "Theme" ) );
			m_asApps.Add( new GalleryItem( "RscWallsV10;Images/Ico001_Walls.jpg", "Wallpaper" )  );
			m_asApps.Add( new GalleryItem( "RscFileTypesV10;Images/Ico001_FileTypes.jpg", "File Type Associations" )  );
			m_asApps.Add( new GalleryItem( "RscDeviceInfoV11;Images/Ico001_DeviceInfo.jpg", "Device Information" )  );
		}
		...
		public MainPage()
        {
			...
			m_AppFrame = new RscAppFrame("Ressive.Hu", csTitle, "Images/Ico001_Settings.jpg"
			...
			for( int i = 0; i < m_iCX; i++ )
			{
				if( gal.m_a[ i ].Name != "blank" )
				{
					...
					try
					{
						...
						string [] astr = gal.m_a[ i ].Name.Split(';');
						string sImg = astr[ 1 ];
						...
						ib.Image.Source = bmp;
						*/
						ib.Image.Source = m_AppFrame.Theme.GetImage(sImg);
		...
		private void m_Image_Click(object sender, System.Windows.RoutedEventArgs e)
		{
			...
			string [] astr = m_a[ iYcurr ].m_a[ iXcurr ].Name.Split(';');
			string sPage = astr[ 0 ];
			
			string sUri = csAssyName + sPage + ".xaml";
