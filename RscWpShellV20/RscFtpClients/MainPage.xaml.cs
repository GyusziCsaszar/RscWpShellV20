...
namespace RscFtpClients
{
    public partial class MainPage : PhoneApplicationPage
    {
		...
		const string csTitle = "FTP Clients";
		
		const string csAssyName = "/RscFtpClients;component/";
		
		private void AddApps( )
		{
			m_asApps.Add( new GalleryItem( "RscFtp_ExplorerV11;Images/Ico001_FtpTest.jpg", "FTP Explorer" ) );
			m_asApps.Add( new GalleryItem( "RscFtp_UpLoadV11;Images/Ico001_FtpUpLoad.jpg", "FTP Upload" )  );
			m_asApps.Add( new GalleryItem( "RscFtp_DownLoadV11;Images/Ico001_FtpDownLoad.jpg", "FTP Download" )  );
		}
        ...
        public MainPage()
        {
			...
			m_AppFrame = new RscAppFrame("Ressive.Hu", csTitle, "Images/Ico001_FtpTest.jpg"
