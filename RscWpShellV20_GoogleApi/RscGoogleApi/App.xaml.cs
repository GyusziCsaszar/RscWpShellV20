...
using RscGoogleApi.Resources;

using System.IO.IsolatedStorage;
using System.IO;

namespace RscGoogleApi
{
    public partial class App : Application
    {
        ...
        private void RootFrame_NavigationFailed(object sender, NavigationFailedEventArgs e)
        {
   			...
   			else
			{
				...
				for(;;)
				{
					...
					if( !store.FileExists(sPathWrk + ".error") ) break;
					i++;
				}
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
  			...
  			else
			{
				...
				//ATT: Programatically exiting app...
				if( e.ExceptionObject.Message == "Cannot go back when CanGoBack is false." )
					return;
				
				string sException = "Application_UnhandledException...\n\nMessage:\n" + e.ExceptionObject.Message +
