...
namespace RscDC
{
    ...
    public partial class MainPage : PhoneApplicationPage
    {
		...
		const string csTitle = "Digital Camera";
		const string csAssyName = "/RscDC;component/";
		
		private void AddApps( )
		{
			m_asApps.Add( new GalleryItem( "RscDC_CameraV11;Images/Ico001_PhotoCamera.jpg", "Photo Camera" )  );
			m_asApps.Add( new GalleryItem( "RscDC_CamcorderV11;Images/Ico001_Camcorder.jpg", "Video Camera" )  );
		}
        ...
        public MainPage()
        {
			...
			m_AppFrame = new RscAppFrame("Ressive.Hu", csTitle, "Images/Ico001_PhotoCamera.jpg"
